const API_URL ="http://www.omdbapi.com/?i=tt3896198&apikey=82a10a2";
const API_URL_SEARCH ="http://www.omdbapi.com/?apikey=82a10a2";
    ...
    <div class="card"> 
       <><img src="${imovie.Poster}" alt="Poster" width="300px" height="300px" /><br>
            <div class="movie-discription">
                <span class="movie-title><b>Title</b><span class=" value />" >${imovie.Title}</span></span><span class="movie-title><b>Rating</b><span class=" value /></>" >${imovie.imdbRating</span></span>
